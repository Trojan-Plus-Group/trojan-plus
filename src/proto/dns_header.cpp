...
void dns_question::test_cases(){
    ...
    string test_data("\x6c\xad\x01\x20\x00\x01\x00\x00\x00\x00\x00\x01\x03\x77\x77\x77\x05\x62\x61\x69\x64\x75\x03\x63\x6f\x6d\x00\x00\x1c\x00\x01",31);
...
istream& dns_answer::read_answer(istream& is, answer& an){
    ...
    if(an.TYPE == dns_header::QTYPE_A_RECORD){
        uint32_t addr = parse_uint32(0, an.RD);
        an.A = boost::asio::ip::make_address_v4(addr).to_string();
    }else if(an.TYPE == dns_header::QTYPE_A_RECORD){
        an.AAAA = boost::asio::ip::make_address_v6(an.RD.data()).to_string();
    }
...
void dns_answer::test_cases(){
    {
        string test_data("",135);
        istringstream is(test_data);
        ...
        _test_case_assert_str(answer.get_answers()[1].A , "180.101.49.12");
        ...
        _test_case_assert_str(answer.get_answers()[2].A , "180.101.49.11");
    }

    {
        string test_data("",126);
        istringstream is(test_data);
        ...
        _test_case_assert(answer.get_additionals()[0].TYPE , 41); // OPT: http://www.networksorcery.com/enp/rfc/rfc2671.txt
